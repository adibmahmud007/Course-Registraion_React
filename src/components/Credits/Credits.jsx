...
const Credits = ({price,credit,title}) => {
    ...
    return (
        <div className="lg:w-1/4 lg:m-3 lg:p-3 rounded-2xl bg-white mt-4">
           ...
           <h3 className="text-blue-500 lg:font-bold lg:text-center lg:text-xl lg:mt-3 lg:pb-5 font-bold text-center p-4 border-b-2 text-xl">Credits Hour Remaining  hour </h3>
           </div>
           <div>
